...
save(nmp_1,fdr_1,power_1,nmp_arl_1,fdr_arl_1,power_arl_1,nmp_thrl_1,fdr_thrl_1,power_thrl_1,nmp_lasso_1,fdr_lasso_1,power_lasso_1,file="output-1.RData")
